    ...
    async def on_channel_message(self, message):
        ...
        try:
            if "x" in joystick_data and "y" in joystick_data:
                ...
                clicked_point_msg.x = joystick_data["x"]  # Replace with your x coordinate
                clicked_point_msg.y = joystick_data["y"]  # Replace with your y coordinate
                ...
                rospy.logerr("Received message does not contain 'x' and 'y' keys.")
        except Exception as e:
            rospy.logerr("Error publishing clicked point: %s", str(e))
        # *** ROS Publisher
